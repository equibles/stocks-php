...
# **insiders**
> \EquiblesStocks\Models\TransactionsResponse insiders($apiKey, $fullTicker, $page, $pageSize)
...
$apiInstance = new EquiblesStocks\Clients\TransactionsApi(
...
try {
    $result = $apiInstance->insiders($apiKey, $fullTicker, $page, $pageSize);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TransactionsApi->insiders: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\EquiblesStocks\Models\TransactionsResponse**](../Model/TransactionsResponse.md)
...
# **institutional**
> \EquiblesStocks\Models\TransactionsResponse institutional($apiKey, $fullTicker, $page, $pageSize)
...
try {
    $result = $apiInstance->institutional($apiKey, $fullTicker, $page, $pageSize);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TransactionsApi->institutional: ', $e->getMessage(), PHP_EOL;
}
?>
```
